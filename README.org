...
- [[http://download.savannah.gnu.org/releases/guile-json/guile-json-4.2.0.tar.gz][guile-json-4.2.0.tar.gz]]
...
into a record type and viceversa. This feature works very well, for example,
